...
export function ClaimBox({
  ...
  return (
    <section className="mb-5 flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="w-full min-w-0 lg:max-w-[35rem] rounded-2xl border border-neutral-200 bg-white p-4 sm:p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
