    ...
    <main>
      ...
      <div className="space-y-6 text-sm text-neutral-700 leading-relaxed max-w-lg dark:text-neutral-300">
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              The first 50 unique businesses that successfully pay and go live become
              the Founding 50.
            </li>
            <li>
              A business counts once. Raising an existing bid does not take another
              Founding 50 spot.
            </li>
            <li>
              Pending, abandoned, failed, or incomplete payments do not count.
            </li>
            <li>
              Until 50 businesses have joined, Founding 50 and the Leaderboard show
              the same live ranking.
            </li>
            <li>
              When the 50th business joins, Founding 50 locks. Founding ranks #1–#50
              are captured at that moment and never change.
            </li>
            <li>
              After lock, the Leaderboard keeps using the normal bid ranking. Founding
              rank and leaderboard rank are separate.
            </li>
            <li>
              Later businesses appear on the Leaderboard only. They are not added to
              Founding 50.
            </li>
          </ul>
        </section>
